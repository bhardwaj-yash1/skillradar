...
CANONICAL_SKILLS: dict[str, tuple[str, str]] = {
    ...
    "mlflow": ("MLflow", "tool"),
    "dbt": ("dbt", "tool"),
    "databricks": ("Databricks", "tool"),
    "snowflake": ("Snowflake", "tool"),
    "opencv": ("OpenCV", "framework"),
    "ci cd": ("CI/CD", "tool"),
    "cicd": ("CI/CD", "tool"),
    "feature store": ("Feature Stores", "concept"),
    "feature stores": ("Feature Stores", "concept"),
    "experimentation": ("Experimentation", "concept"),
    "ab testing": ("Experimentation", "concept"),
    "a b testing": ("Experimentation", "concept"),
    "data modeling": ("Data Modeling", "concept"),
    "data model": ("Data Modeling", "concept"),
    "bi reporting": ("BI Reporting", "tool"),
